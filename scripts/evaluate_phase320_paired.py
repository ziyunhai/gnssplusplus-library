...
MANIFEST = RECORDS / 'smartphone_r5_phase320_paired_accuracy_manifest_v1.json'
RESULT = RECORDS / 'smartphone_r5_phase320_paired_accuracy_result_v1.json'
...
def evaluate():
    ...
    spec = importlib.util.spec_from_file_location('phase203_for_320', path)
    ...
    result = dict(score, phase=320, role=m['role'], baseline_m=m['baseline_m'],
