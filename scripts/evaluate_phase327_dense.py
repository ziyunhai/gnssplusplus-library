...
MANIFEST = RECORDS / 'smartphone_r5_phase327_dense_accuracy_manifest_v1.json'
RESULT = RECORDS / 'smartphone_r5_phase327_dense_accuracy_result_v1.json'
...
def evaluate():
    ...
    spec = importlib.util.spec_from_file_location('phase203_for_327', path)
    ...
    result = dict(score, phase=327, role=m['role'], baseline_m=m['baseline_m'],
