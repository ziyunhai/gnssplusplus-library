...
MANIFEST = RECORDS / 'smartphone_r5_phase330_mask_only_accuracy_manifest_v1.json'
RESULT = RECORDS / 'smartphone_r5_phase330_mask_only_accuracy_result_v1.json'
...
def verify():
    ...
    assert s['mask_only_requested'] is True and s['nonzero_correction_enabled'] is False
...
def evaluate():
    ...
    spec = importlib.util.spec_from_file_location('phase203_for_330', path)
    ...
    result = dict(score, phase=330, role=m['role'], baseline_m=m['baseline_m'],
