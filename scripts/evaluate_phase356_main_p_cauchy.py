...
MANIFEST = RECORDS / 'smartphone_r5_phase356_main_p_cauchy_accuracy_manifest_v1.json'
RESULT = RECORDS / 'smartphone_r5_phase356_main_p_cauchy_accuracy_result_v1.json'
...
def verify():
    ...
    assert s['main_p_cauchy_requested'] is True
...
def evaluate():
    ...
    spec = importlib.util.spec_from_file_location('phase203_for_356', path)
    ...
    result = dict(score, phase=356, role=m['role'], baseline_m=m['baseline_m'],
