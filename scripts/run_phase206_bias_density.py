"""Run the frozen Phase206 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase206_h_native_phase205_bias_density_manifest_v1.json"
...
def main():
    ...
    assert "--native-phase205-source-count-bias-density" in argv
