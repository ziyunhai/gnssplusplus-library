"""Run the frozen Phase210 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase210_h_native_phase209_separate_imu_manifest_v1.json"
...
def main():
    ...
    assert "--native-phase209-source-separate-imu-factors" in argv
