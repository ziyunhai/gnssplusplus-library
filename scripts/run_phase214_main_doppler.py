"""Run the frozen Phase214 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase214_h_native_phase213_main_doppler_manifest_v1.json"
