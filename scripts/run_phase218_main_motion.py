"""Run the frozen Phase218 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase218_h_native_phase217_main_motion_manifest_v1.json"
...
def main():
    ...
    assert "--native-phase213-main-doppler" not in argv
