"""Run the frozen Phase222 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase222_h_native_phase221_combined_motion_doppler_manifest_v1.json"
