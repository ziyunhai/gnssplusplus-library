"""Run the frozen Phase236 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase236_h_native_phase235_joint_source_noise_manifest_v1.json"
...
def main():
    ...
    assert "--native-phase184-source-tdcp-huber-k" in argv
