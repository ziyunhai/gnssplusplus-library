"""Run the frozen Phase243 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase243_h_native_phase242_source_resl_manifest_v1.json"
...
def main():
    ...
    assert "--native-source-tdcp-resl-observable" in argv
