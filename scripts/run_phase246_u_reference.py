"""Run the frozen Phase246 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase246_u_native_reference_transfer_manifest_v1.json"
