"""Run the frozen Phase249 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase249_u_native_first_epoch_manifest_v1.json"
...
def main():
    ...
    assert "--android-include-first-native-epoch" in argv
