"""Run the frozen Phase254 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase254_h_native_phase253_affine_geometry_manifest_v1.json"
...
def main():
    ...
    assert "--native-tdcp-only-affine-geometry" in argv
