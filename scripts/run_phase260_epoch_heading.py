"""Run the frozen Phase260 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase260_h_native_phase259_epoch_heading_manifest_v1.json"
...
def main():
    ...
    assert "--native-epoch-heading-attitude-seeds" in argv
