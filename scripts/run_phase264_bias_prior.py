"""Run the frozen Phase264 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase264_h_native_phase263_bias_prior_manifest_v1.json"
...
def main():
    ...
    assert "--native-omit-first-imu-bias-prior" in argv
