"""Run the frozen Phase268 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase268_h_native_phase267_velocity_prior_manifest_v1.json"
...
def main():
    ...
    assert "--native-omit-first-imu-velocity-prior" in argv
