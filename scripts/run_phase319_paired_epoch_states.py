"""Run the frozen Phase319 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase319_h_paired_epoch_states_manifest_v1.json"
