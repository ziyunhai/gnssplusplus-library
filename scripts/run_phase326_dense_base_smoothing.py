"""Run the frozen Phase326 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase326_h_dense_base_smoothing_manifest_v1.json"
