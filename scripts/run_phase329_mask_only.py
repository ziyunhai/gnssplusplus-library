"""Run the frozen Phase329 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase329_h_mask_only_manifest_v1.json"
...
def main():
    ...
    assert "--native-base-mask-only-ablation" in argv
