"""Run the frozen Phase350 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase350_h_gps_values_only_manifest_v1.json"
