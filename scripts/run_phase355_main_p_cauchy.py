"""Run the frozen Phase355 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase355_h_main_p_cauchy_manifest_v1.json"
...
def main():
    ...
    assert "--native-main-p-cauchy" in argv
