"""Run the frozen Phase361 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase361_h_stationary_gyro_manifest_v1.json"
...
def main():
    ...
    assert "--native-stationary-gyro-initializer" in argv
