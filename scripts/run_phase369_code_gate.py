"""Run the frozen Phase369 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase369_u_code_gate_manifest_v1.json"
