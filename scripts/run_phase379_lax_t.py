"""Run the frozen Phase379 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase379_lax_t_diagnostic_manifest_v1.json"
