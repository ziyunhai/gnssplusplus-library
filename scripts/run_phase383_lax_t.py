"""Run the frozen Phase383 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase383_lax_t_comparison_manifest_v1.json"
...
def main():
    ...
    assert "--native-tdcp-no-code-jump-gate" in argv
