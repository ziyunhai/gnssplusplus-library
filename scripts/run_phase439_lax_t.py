"""Run the frozen Phase439 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase439_lax_t_comparison_manifest_v1.json"
