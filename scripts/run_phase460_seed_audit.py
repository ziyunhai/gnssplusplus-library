...
def main():
    ...
    directory = ROOT / 'output/smartphone-r5/phase460-lax-seed-audit-v1'
    ...
    manifest = dict(phase=460, argv=argv, binary=prior['binary'],
    ...
    for path in ('src/algorithms/raw_p_seed.cpp', 'src/algorithms/spp.cpp',
                 ...
                 'include/libgnss++/algorithms/spp.hpp', 'scripts/run_phase460_seed_audit.py'):
