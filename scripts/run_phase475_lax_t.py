"""Run the frozen Phase475 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase475_lax_t_comparison_manifest_v1.json"
...
def main():
    ...
    argv = manifest["argv"]
    assert "--native-lm-lambda-floor" in argv
    ...
    assert "--native-sparse-p-staging" in argv
    assert "--native-tdcp-frequency-residual-states" not in argv
