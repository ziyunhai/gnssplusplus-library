"""Run the frozen Phase479 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase479_h_baseline_replay_manifest_v1.json"
