"""Run the frozen Phase480 raw-only experiment once; never evaluate truth."""
...
MANIFEST = ROOT / "docs/use_cases/records/smartphone_r5_phase480_u_comparison_manifest_v1.json"
