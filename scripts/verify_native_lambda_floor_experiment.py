...
def check_stage(stage):
    ...
    assert stage['linear_solver'] == 'MULTIFRONTAL_QR'
...
def main():
    path = ROOT / 'docs/use_cases/records/smartphone_r5_phase475_lax_t_comparison_manifest_v1.json'
    ...
    for stage in ('main', 'gnss_first'):
        check_stage(summary['phase143_termination'][stage])
