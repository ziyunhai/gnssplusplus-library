...
MANIFEST = ROOT / 'docs/use_cases/records/smartphone_r5_phase390_lax_t_comparison_manifest_v1.json'
...
def verify():
    ...
    return {'candidate_sha256': actual, 'byte_identical_to_phase382': True,
