...
MANIFEST = ROOT / 'docs/use_cases/records/smartphone_r5_phase411_lax_t_comparison_manifest_v1.json'
...
def verify():
    ...
    assert actual == manifest['expected_candidate_sha256'], 'replay changed output'
    ...
    assert n == tdcp['factors_built'] == tdcp['factors_inserted'] == 24964
    ...
    return {'signal_aggregates': groups, 'candidate_sha256': actual, 'byte_identical_to_phase382': True,
