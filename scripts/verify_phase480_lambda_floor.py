...
def main():
    path = ROOT / 'docs/use_cases/records/smartphone_r5_phase480_u_comparison_manifest_v1.json'
    ...
    ranges = parse_failed_lambda((ROOT / manifest['launcher_contract']['stderr_path']).read_text())
