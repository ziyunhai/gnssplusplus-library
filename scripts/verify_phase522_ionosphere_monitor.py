...
def main():
    directory = ROOT / 'output/smartphone-r5/phase522-h-ionosphere-monitor-v1/mtv-h'
    ...
    print(json.dumps(dict(residual=residual, verified=True, output_identical=True, monitor=monitor,
