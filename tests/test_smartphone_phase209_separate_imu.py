"""Runtime rejection tests for the opt-in separate IMU factors; no raw data."""
import os
...
FLAG = '--native-phase209-source-separate-imu-factors'
LANE = [
...
def test_reject_invalid_configuration(args):
    ...
    assert 'Phase209 requires' in result.stderr
